      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-red-600 text-white rounded-3xl p-6 sm:p-8 shadow-xl space-y-4">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="w-full inline-flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-red-700 font-black text-lg py-4 px-6 rounded-2xl shadow-lg transition-transform active:scale-95"
                >
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 bg-red-900/60 hover:bg-red-900/80 text-white font-bold text-xs py-3 px-4 rounded-xl border border-white/20 transition-colors"
              >
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-card-elevated">
            ...
            <div className="text-center py-6">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2.5 bg-red-600 hover:bg-red-700 text-white font-black text-base py-4 px-8 rounded-2xl shadow-lg transition-all active:scale-95"
              >
