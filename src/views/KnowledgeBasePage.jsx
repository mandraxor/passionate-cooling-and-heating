    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="bg-[#07152b] text-white pt-14 pb-20 relative overflow-hidden">
        <div className="absolute inset-0 opacity-15 pointer-events-none">
          <div className="absolute top-0 right-10 w-96 h-96 bg-red-600 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-10 w-80 h-80 bg-sky-600 rounded-full blur-3xl"></div>
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-red-600/90 text-white px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider mb-4 shadow-md">
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white/10 backdrop-blur border border-white/20 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500 text-sm sm:text-base shadow-inner"
            />
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="p-6 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <h2 className="text-lg sm:text-xl font-black text-[#07152b] group-hover:text-red-600 transition-colors leading-snug mb-3">
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between mt-auto">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1 text-xs font-black text-red-600 group-hover:translate-x-1 transition-transform"
                  >
      ...
      <section className="bg-[#07152b] text-white py-14">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-600 text-white text-xs font-bold uppercase tracking-wider">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <a
              ...
              className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-black px-7 py-3.5 rounded-xl text-base shadow-lg transition-transform hover:scale-105"
            >
